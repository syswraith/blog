...
1. Immediately we can see that the script requires a `flag.txt` file in the same directory. Create it and make it something easy to spot. I'm going for the following:
