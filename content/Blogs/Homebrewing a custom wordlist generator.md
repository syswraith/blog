...
1. `python3 main.py passwords` to start generating the passwords
1. `python3 main.py filter` to filter out passwords according to the filters
1. `python3 main.py clear_cache` to clear the generated cache
1. `python3 main.py clear_profiles` to clear the generated profiles
1. `python3 main.py clear_wordlists` to clear the generated wordlists
